...
en_dict = {
  ...
  "packages.dep.desc": "Breeze through check-in and priority immigration.",
  "packages.dep.features": "Breeze through check-in|Personal meet at terminal entrance|Check-in assistance (if needed)|Priority immigration lane|Express passport control|Gate escort & chat support",
  ...
  "reviews.9.n": "Ahmed Y.", "reviews.9.t": "Magical departure", "reviews.9.d": "The departure combo is purely magical. No stress at check-in or passport control whatsoever. It honestly felt like a true premium VIP service.",
